# Projeto do Curso - NestJS Zero to Hero
...
Sinta-se à vontade para explorar o código e os commits para entender melhor a progressão do projeto ao longo do curso. Se tiver alguma dúvida ou sugestão, fique à vontade para abrir uma issue.